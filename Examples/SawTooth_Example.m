...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Lattice parameters
M=5; % Number of Unit Cells
M=2*M; % Number of Lattice sites
...
Jdash=-sqrt(2); J=-1; U=1; E=0*ones(M,1); u_chem=0;
...
for tt = 1:time_steps
    ...
    [state,Total_error]=state.TEBD_Local_2s_Gates_SawTooth(dt,J,Jdash,U,E-u_chem);
